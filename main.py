    """
    Oauth Bridge Klu0ixi
    ====================
    Minimal HTTP service that acts as a proxy layer for existing third-party APIs.
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Minimal HTTP service that acts as a proxy layer for existing third-party APIs.")
